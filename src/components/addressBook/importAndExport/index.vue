                    ...
                    <section>
                        ...
                        <div class="right">
                            ...
                            <div style="display:flex">
                                ...
                                <div class="file-down" style="margin-left:30px">
                                    <span>教职工通讯录信息</span>
                                    <a href="javascript:void(0)" @click="exportExcel('teacher')">导出</a>
                                </div>
                            </div>
                            <div class="file-down-msg" v-show="fileDown == ''">
                                还没有导出通讯录
                            </div>
                            <div class="file-down-msg-success" v-show="fileDown !=''">
                                导出通讯录成功
