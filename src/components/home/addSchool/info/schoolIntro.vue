  ...
  <div id="school-intro">
    <el-tabs v-model="activeName">
      <el-tab-pane label="招生简章" name="1">
        <div class="title">
          <el-button type="primary" icon="el-icon-plus" size="small" @click="add(1)">添加招生简章</el-button>
        </div>
        <div class="box">
          <div class="leaflet-list" v-for="(item,index) in bookletListForCollege">
            <div class="list-left">
              <span>{{index + 1}}.</span>
      ...
      <el-tab-pane label="历届考题" name="2">
        <div class="title">
          <el-button type="primary" icon="el-icon-plus" size="small" @click="add(2)">添加历届考题</el-button>
        </div>
        <div class="box">
          <div class="leaflet-list" v-for="(item,index) in topicListForCollege">
            <div class="list-left">
              <span>{{index + 1}}.</span>
              <img src="@/assets/images/default.png" alt="" v-if="item.url_cover.length<=10">
              <img :src="item.url_cover" alt="" v-else>
      ...
      <el-tab-pane label="高分卷" name="3">
        <div class="title">
          <el-button type="primary" icon="el-icon-plus" size="small" @click="add(3)">添加高分卷</el-button>
        </div>
        <div class="box">
          <div class="leaflet-list" v-for="(item,index) in highScoreListForCollege">
            <div class="list-left">
              <span>{{index + 1}}.</span>
              <img src="@/assets/images/default.png" alt="" v-if="item.url_cover.length<=10">
              <img :src="item.url_cover" alt="" v-else>
  ...
  export default{
    ...
    methods: {
      ...
      edit(index, id){
        ...
        this.getOneArticleContentOfCollegeInfo(index - 1, id);
