    ...
    <div>
      ...
      <div class="site">
        ...
        <div>
          ...
          <ul class="site-list">
            <li class="item" v-for="(item,index) in siteList">
      ...
      <div class="specialty">
        ...
        <div>
          <ul class="specialty-list">
            <li class="item" v-for="(item,index) in profession">
  ...
  export default{
    ...
    methods: {
      ...
      showProfessionTime(item){
        ...
        this.applyTime[0] = item.time_signup_start || timestamp;
        this.applyTime[1] = item.time_signup_end || timestamp;
        this.affirmTime[0] = item.time_confirm_start || timestamp;
        this.affirmTime[1] = item.time_confirm_end || timestamp;
      ...
      updateTimeForCollegeProfession(){
        ...
        this.form.time_confirm_start = this.affirmTime[1];
